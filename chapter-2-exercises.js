...
funtion treeFunc() {
  ...
  for (var i = 0; tree.length < 7; i++) {
    tree += "#";
    console.log(tree);
  }
};

/* Exercise 2: Write a program that uses console.log to print all the numbers from 1 to 100, with two exceptions. 
...
/* Exercise 3: Write a program that creates a string that represents an 8×8 grid, using newline characters to separate lines. 
